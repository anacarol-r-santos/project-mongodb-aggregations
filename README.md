...
Neste projeto serão utilizadas várias coleções, de forma que sej possível praticar em vários cenários os diversos operadores e estágios do `aggregation pipeline`.

Trabalharemos com dados do **IMDB**, dados sobre empresas aéreas e também dados que contenham registros de deslocamento de pessoas que utilizam bicicletas. 
...
1. Clone o repositório
  * `git clone git@github.com:anacarol-r-santos/project-mongodb-aggregations.git`.
...
Ajude a escolher um filme para a próxima noite! Baseado em uma pesquisa, decidimos que os filmes em potencial devem atender alguns critérios, vejamos:
